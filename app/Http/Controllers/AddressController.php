...
//        $address = Address::where('user_id',Auth::user()->id)->get();
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($address))
        {
            return redirect('/address')->with('alert', 'Anda sudah mengisi Data Diri.');
        }
...
//        dd($address);
        return redirect('/address')->with('status', 'Data Diri Berhasil ditambahkan!');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('address')->with('status', 'Data Diri berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('status', 'Data Diri Berhasil Dihapus!');
    }
}
